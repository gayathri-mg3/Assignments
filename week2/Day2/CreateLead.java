...
public class CreateLead {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("(//span[@class='requiredField']/following::input)[1]")).sendKeys("River");
		driver.findElement(By.xpath("//span[@class='requiredField']/following::input[@name='firstName']")).sendKeys("Gayathri");
		driver.findElement(By.xpath("//span[@class='requiredField']/following::input[@name='lastName']")).sendKeys("Manoharan");
